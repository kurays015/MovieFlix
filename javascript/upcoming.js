const upcomingContainer = document.querySelector('.upcoming-movie')

//render top rated on the webpage
function renderUpcoming(upcomingData, genresList) {
 ...
 //Each movie card modal
    const cardClicked = document.querySelectorAll('.upcoming-card')
